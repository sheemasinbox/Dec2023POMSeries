...
public class ElementUtil {
	...
	private void nullBlankCheck(String value) {
		if (value == null || value.length() == 0) {
			throw new ElementException(value + "visible text cannot be null");
		}
	}
	...
	// getText
		public String doGetElementText(By locator, int timeOut) {
	...
	@Step("Checking element {0} is displayed...")   //{0} is 1st parameter, {1} 2nd parameter, etc
